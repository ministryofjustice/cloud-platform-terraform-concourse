...
| <a name="input_hoodaw_irsa_enabled"></a> [hoodaw\_irsa\_enabled](#input\_hoodaw\_irsa\_enabled) | Enable IRSA for hoodaw, set to false for test clusters | `any` | n/a | yes |
