...
| <a name="input_teams_filter_api_key"></a> [teams\_filter\_api\_key](#input\_teams\_filter\_api\_key) | API key to authenticate data posts to https://github-teams-filter.apps.live.cloud-platform.service.justice.gov.uk/filter-teams | `any` | n/a | yes |
