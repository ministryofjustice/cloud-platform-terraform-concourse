...
module "example_team_concourse" {
  ...
  teams_filter_api_key                                = var.teams_filter_api_key
  ...
  github_cloud_platform_concourse_bot_app_id          = var.github_cloud_platform_concourse_bot_app_id
  github_cloud_platform_concourse_bot_installation_id = var.github_cloud_platform_concourse_bot_installation_id
  github_cloud_platform_concourse_bot_pem_file        = var.github_cloud_platform_concourse_bot_pem_file
